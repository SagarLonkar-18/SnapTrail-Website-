            ...
            <div className="bg-white shadow-sm ">
                <div className="mx-auto px-4 py-2 flex justify-between items-center">
                    <Link to="/" className='flex items-center mr-5'>
                        <img src="https://www.iconarchive.com/download/i103380/paomedia/small-n-flat/device-camera.1024.png"
                            alt="SnapTrail" className='h-6 md:mr-2'
                        />
                        <span className='text-red-600 text-xl font-bold '>Snaptrail</span>
                    </Link>
